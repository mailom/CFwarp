...
if [[ ${bit} == "x86_64" ]]; then
wget -N https://github.com/kkkyg/CFwarp/raw/main/wgcf_2.2.9_amd64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
elif [[ ${bit} == "aarch64" ]]; then
wget -N https://github.com/kkkyg/CFwarp/raw/main/wgcf_2.2.9_arm64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf
fi
if [[ ${vi} == "lxc" || ${vi} == "openvz" ]]; then
wget -N https://github.com/kkkyg/CFwarp/raw/main/wireguard-go -O /usr/bin/wireguard-go && chmod +x /usr/bin/wireguard-go
fi
...
function upcore(){
wget -N --no-check-certificate https://github.com/kkkyg/CFwarp/raw/main/ucore.sh && chmod +x ucore.sh && ./ucore.sh
}
